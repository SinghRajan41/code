...
template<class Y> void queue<Y>::nq_front(Y value)
{
   a=new node<Y>;
   a->data=value;
   if(first == NULL)
...
template<class Y> void queue<Y>::dq_front()
{
   if(first == NULL)
   {
...
template<class Y> void queue<Y>::nq_back(Y value)
{
   a=new node<Y>;
   a->data=value;
   if(first == NULL)
...
template<class Y> void queue<Y>::dq_back()
{
   if(first == NULL)
   {
